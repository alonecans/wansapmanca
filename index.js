...
break
		case 'ttp':
                    ...
                    client.sendMessage(from, buffer, sticker, {sendEphemeral: true, thumbnail: fs.readFileSync('./src/manca.jpg', 'base64')})
                    break
		case 'thunder':
				// NuyFaa
                 if (!isRegistered) return reply( ind.noregis())
		...
		case 'shota':
         ...
         case 'neko':
           ...
           case 'fuckboy':
                ...
                if (args.length == 0) return reply(`Example: ${prefix + command} Manca`)
                txt = args.join(" ")
				buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/${command}?apikey=${LoLKey}&name=${txt}`)
				client.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "MANCA BOT\nBY NUYFAA", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 736, "width": 736, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./src/manca.jpg')} } }, contextInfo: { forwardingScore: 1, isForwarded: true}})
				break
          case 'logogaming':
             if (!isRegistered) return reply( ind.noregis())
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				reply(ind.wait())
				logoo = body.slice(8)
                    buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/ephoto1/logogaming?apikey=${LoLKey}&text=${logoo}`)
                    client.sendMessage(from, buffer, image, {caption: 'Nih kak....\n\n*Follow!!* : @thenay_xploit_\n\nJangan Pake Nya Doang!!', quoted: ftoko})
                    break
             case 'robot': 
                   if (!isRegistered) return reply( ind.noregis())
             ...
             case 'marvel':
               ...
               break
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				reply(ind.wait())
				anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/meme?apikey=${LoLKey}`, {method: 'get'})
				buffer = await getBuffer(anu.result)
				client.sendMessage(from, buffer, image, {quoted: ftoko})
				await limitAdd(sender)
				break
		...
		case 'covidglobal':    
				...
				client.updatePresence(from, Presence.composing) 
			    tels = body.slice(12)
				asu = await fetchJson(`http://lolhuman.herokuapp.com/api/corona/global?apikey=${LoLKey}`)
		...
		case 'ceknamaff': 
				...
				//Hayo Mau Ngapain?
					gatauda = body.slice(11)
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/freefire/${gatauda}?apikey=${LoLKey}`)
					reply(anu.result)
					await limitAdd(sender)
					break
		case 'ceknamaml': 
				...
				//Hayo Mau Ngapain?
					gatauda = body.slice(11)
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/mobilelegend/${gatauda}?apikey=${LoLKey}`)
					reply(anu.result)
					await limitAdd(sender)
					break
		case 'namaninja': 
		...
		case 'pinterest':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					nimek =  n[Math.floor(Math.random() * n.length)];
					pok = await getBuffer(nimek)
					client.sendMessage(from, pok, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "MANCA BOT\nBY NUYFAA", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 736, "width": 736, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./src/manca.jpg')} } }, caption: `*PINTEREST*`})
					await limitAdd(sender)
					break 
           case 'glitchtext':
           ...
           case 'waifu':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					//Hayo Mau Ngapain?
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/waifu?apikey=${LoLKey}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek })
					await limitAdd(sender) 
					break
           case 'randombts':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					//Hayo Mau Ngapain?
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/bts?apikey=${LoLKey}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek })
					await limitAdd(sender) 
					break
           case 'randomexo':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					//Hayo Mau Ngapain?
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/exo?apikey=${LoLKey}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek })
					await limitAdd(sender) 
					break
           /*case 'blackpink':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					//Hayo Mau Ngapain?
					anu = await fetchJson(http://lolhuman.herokuapp.com/api/random/blackpink?apikey=${LoLKey}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek })
					await limitAdd(sender) 
					break*/
           ...
           case 'imagegame':
		     ...
		     case 'fakta':
				...
				case 'katabijak':
			        // NuyFaa
                 if (!isRegistered) return reply( ind.noregis())
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/katabijak?apikey=${LoLKey}`, {method: 'get'})
			...
			case 'katailham':
				...
				case 'tebakgambar':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					//Hayo Mau Ngapain?
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/tebak/gambar?apikey=${LoLKey}`, {method: 'get'})
  ...
  break
       ...
       case 'bahasapurba': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					if (args.length < 1) return reply('kasih teks lah^_^!!!')
					purba = body.slice(7)
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/bahasapurba?apikey=${LoLKey}&text=${purba}`, {method: 'get'})
					reply(anu.result)
					await limitAdd(sender)
					break
		case 'halah': 
		...
		case 'alay2': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					if (args.length < 1) return reply('kasih teks lah^_^!!!')
					data = await fetchJson(`http://lolhuman.herokuapp.com/api/upperlower?apikey=${LoLKey}&text=${body.slice(6)}`)
					reply(data.result)
				    await limitAdd(sender)
					break
		case 'fml':	//FxSx
		...
		case 'daftar':
                			...
                			if (umurUser < 12) return reply(`your age is too young minimum 12 years`)
                    			...
                    			await client.sendMessage(from, ppimg, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage":{"product":{"productImage":{"mimetype":"image/jpeg","height":736,"width":736,"jpegThumbnail":fs.readFileSync('./src/manca.jpg')},"productId":"3937202479680283","title":"DDhBlJUoIIUDZgBvnfoHtEyD4g5uKzsPBuyWH1mSmUOASiawlSBEspN3P/AAzQ8ZWfzzmshska0","currencyCode":"IDR","priceAmount1000":"999999999000","productImageCount":1},"businessOwnerJid":"0@s.whatsapp.net"}}}, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: ind.registered(namaUser, umurUser, serialUser, time, sender)})
                    			addATM(sender)
...
${fajri} ${prefix}goodgirl
${fajri} ${prefix}goodboy
${fajri} ${prefix}pacarserti
${fajri} ${prefix}bucinserti
${fajri} ${prefix}fuckgirl
${fajri} ${prefix}fuckboy
${fajri} ${prefix}badboy
${fajri} ${prefix}badgirl
...
client.sendMessage(from, menu, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "MANCA BOT\nBY NUYFAA", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 736, "width": 736, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./src/manca.jpg')} } }, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [num]}, displayname: mem, caption: captionnya})
		    break
		case 'donasi':
		case 'donate':
					// NuyFaa
		...
		case 'pictmenu':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					client.sendMessage(from, wew, image, { quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [num]}, displayname: mem, caption: randompict(prefix)})
					break
		case 'menuowner':
		case 'ownermenu':
					// NuyFaa
...
pp_mc = await getBuffer(pp_user)
                    ini_txt = "Anda telah afk. "
                    if (alasan != "") {
                        ini_txt += "Dengan alasan " + alasan
                    }
                    client.sendMessage(from, pp_mc, image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage":{"product":{"productImage":{"mimetype":"image/jpeg","height":736,"width":736,"jpegThumbnail":fs.readFileSync('./src/manca.jpg')},"productId":"3937202479680283","title":"DDhBlJUoIIUDZgBvnfoHtEyD4g5uKzsPBuyWH1mSmUOASiawlSBEspN3P/AAzQ8ZWfzzmshska0","currencyCode":"IDR","priceAmount1000":"999999999000","productImageCount":1},"businessOwnerJid":"0@s.whatsapp.net"}}}, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: ini_txt })
                    break
